...
namespace OurFoodChain.Bot {
    ...
    public static class DiscordUtils {
        ...
        public static async Task HandlePaginatedMessageReactionAsync(Cacheable<IUserMessage, ulong> cached, ISocketMessageChannel channel, SocketReaction reaction, bool added) {
