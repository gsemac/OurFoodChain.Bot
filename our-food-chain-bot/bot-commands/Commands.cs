...
namespace OurFoodChain.Commands {
    ...
    public class Commands :
        ...
        public async Task Lineage2(string genus, string species) {
            ...
            string image = await AncestryTreeRenderer.GenerateAndSave(sp, AncestryTreeGenerationFlags.Full);
        ...
        public async Task Evolution(string genusName, string speciesName) {
            ...
            if (species != null) {
                ...
                foreach (string line in lines)
                    if (sb.Length + line.Length - 3 < DiscordUtils.MaxMessageLength)
                        sb.AppendLine(line);
                    else {
        ...
        public async Task Evolution2(string genus, string species) {
            ...
            string image = await AncestryTreeRenderer.GenerateAndSave(sp, AncestryTreeGenerationFlags.DescendantsOnly);
