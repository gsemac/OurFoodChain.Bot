    ...
    public class TrophyScanner {
        ...
        private void _startScanner() {
            ...
            Task.Run(async () => {
                ...
                Console.WriteLine(new LogMessage(LogSeverity.Info, "Trophies", "Starting trophy scanner").ToString());
                ...
                Console.WriteLine(new LogMessage(LogSeverity.Info, "Trophies", "Shutting down trophy scanner").ToString());
        ...
        private async Task _scanTrophiesAsync(ScannerQueueItem item) {
            ...
            foreach (Trophy trophy in await _trophy_registry.GetTrophiesAsync())
                ...
                // If an error occurs when checking a trophy, we'll just move on to the next one.
                    ...
                    Console.WriteLine(new LogMessage(LogSeverity.Error, "Trophies", string.Format("Exception occured while checking \"{0}\" trophy: {1}",
                        trophy.GetName(),
                        ex.ToString()
                        )).ToString());
