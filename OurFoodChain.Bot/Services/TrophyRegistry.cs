...
namespace OurFoodChain.Trophies {
    ...
    public class TrophyRegistry {
        ...
        private async Task _registerAllAsync() {
            ...
            Console.WriteLine(new LogMessage(LogSeverity.Info, "Trophies", "Registering trophies").ToString());
            ...
            Console.WriteLine(new LogMessage(LogSeverity.Info, "Trophies", "Finished registering trophies").ToString());
